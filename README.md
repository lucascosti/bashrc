...
I use two additional scripts for easier git usage, both of which are placed in my `~/baschscripts` directory. You can copy/clone these scripts from their original repositories (linked below).
